...
int main()
{
    ...
    int i1[] = {1,2,3,3,4,2,1,1,1};
    int arr[] = {11,1,1,1,1,232,2,2,2,1,1,2,32,1,2,3,1,1231,1,2,3,1,2,41,3,3,2,12,3,2,1,23,2,32};

    // 
    int k;
    cout<<"Enter the Number of smallest to find: ";
    cin>>k;
    
    cout<<"The Kth Smallest Element : "<<ksmallestelement(arr,k)<<endl;
    cout<<"The Kth Smallest in Float array f1: "<<ksmallestelement(f1,k)<<endl;
    cout<<"The Kth Smallest in Integer array i1: "<<ksmallestelement(f1,k)<<endl;
    return 0;
}
